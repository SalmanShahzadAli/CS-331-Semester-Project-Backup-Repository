...
import { Send, ArrowLeft, Loader, Sparkles, Moon, Sun, Plus, User, Activity, Pill, FileText, Menu, X, Trash2, AlertCircle, Dumbbell } from 'lucide-react';

export default function FitnessChatbot({ onBack }) {
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                        ...
                        <h2 style={{ margin: 0, color: isDarkMode ? '#fff' : '#2d3436', display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '1.1rem' }}>
                            <Dumbbell size={24} color="#e74c3c" /> Fitness Coach <Sparkles size={18} color="#e74c3c" />
                        </h2>
                    </div>
                    <button style={{
                        background: '#e74c3c',
